...
const addUploadFeature = requestHandler => (type, resource, params) => {
    if (type === 'UPDATE' && resource === 'hotels') {
        ...
        if (params.data.pictures && params.data.pictures.length) {
            ...
            return convertFileToBase64(newPicture)
                .then(base64Pic => {
                    newPicture.src = base64Pic;
                })
                .then(transformedPic => requestHandler(type, resource, {
                    ...params,
                    data: {
                        ...params.data,
                        pictures: formerPictures,
                    },
                }));
            /*
            return Promise(convertFileToBase64(newPicture))
                .then(base64Pictures => base64Pictures.map((picture64, index) => ({
                    src: picture64,
